...
/* Mega VPN methods */
    ...
    // Call "vpnd" command.
    void delVpnCredential(int /* Slot ID */, CommandDelVpnCredential::Cb&& = nullptr /* Completion */);

    /**
     * @brief This method generates a string with the VPN credential, equivalent to the .conf file generated by the webclient.
     * This data is meant to be generated with the credential details obtained by CommandPutVpnCredentials.
     *
     * Content:
     *    [Interface]
