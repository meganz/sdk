...
public:
    ...
    void createChat(bool group, bool publicchat, const userpriv_vector *userpriv = NULL, const userkey_map *userkeymap = NULL, const char *unifiedkey = NULL, const char *title = NULL);
