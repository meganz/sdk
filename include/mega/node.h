...
private:
    /**
     * @struct UploadThrottling
     * @brief Handles upload throttling and abort handling for synchronization tasks.
     *
    ...
    private:
         ...
         */
        std::chrono::steady_clock::time_point mUploadCounterLastTime{
    ...
    public:
         ...
         */
        bool
            checkUploadThrottling(const unsigned maxUploadsBeforeThrottle,
    ...
    /**
     * @brief Member containing the state and operations for UploadThrottling.
     */
    UploadThrottling mUploadThrottling;
