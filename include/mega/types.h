...
struct Pitag
{
    ...
    inline static PitagPurpose pitagPurposeFromChar(char c)
    {
        switch (c)
        {
            case '.':
            ...
            default:
                return PitagPurpose::Unknown; // invalid
        }
    }

    inline static PitagTrigger pitagTriggerFromChar(char c)
    {
        switch (c)
        {
            case '.':
    ...
    inline static PitagNodeType pitagNodeTypeFromChar(char c)
    {
        switch (c)
        {
            case '.':
    ...
    inline static PitagTarget pitagTargetFromChar(char c)
    {
        switch (c)
        {
            case '.':
    ...
    inline static PitagImportSource pitagImportSourceFromChar(char c)
    {
        switch (c)
        {
            case '.':
    ...
    static std::optional<Pitag> fromString(const std::string& pitagString)
    {
