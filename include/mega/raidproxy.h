...
public:
    ...
    int64_t trigger(raidTime = 0, bool = false);              // Add request for processing in RaidReqPool (with an optional delay). Also checks if this part shouldn't be processed.
