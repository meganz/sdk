...
class MegaApiImpl : public MegaApp
{
    public:
        ...
        void removeSync(handle nodehandle, MegaRequestListener *listener=NULL, handle backupDestination = UNDEF);
        void removeSyncById(handle backupId, MegaRequestListener *listener=NULL, handle backupDestination = UNDEF);
        ...
        void stopSyncs(MegaRequestListener *listener=NULL, MegaHandle backupDestination = UNDEF);
