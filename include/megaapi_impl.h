...
protected:
    ...
    batchResult createNextFolderBatch(Tree& tree, vector<NewNode>& newnodes, int filecount, bool isBatchRootLevel);
...
protected:
    ...
    std::unique_ptr<TransferQueue> createFolderGenDownloadTransfersForFiles(FileSystemType fsType, int filesCount, Error& e);
