...
class MegaApiImpl : public MegaApp
{
    public:
        ...
        void syncFolder(const char *localFolder, const char *name, MegaHandle megaHandle, SyncConfig::Type backupType, MegaRegExp *regExp = NULL, MegaRequestListener* listener = NULL);
