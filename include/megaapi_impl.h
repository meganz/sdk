...
#ifdef ENABLE_CHAT
        void createChat(bool group, bool publicchat, MegaTextChatPeerList *peers, const char *title = NULL, const char *unifiedKey = NULL, MegaRequestListener *listener = NULL);
...
protected:
        ...
        virtual void chatlinkurl_result(handle, int, string*, string *, error);
