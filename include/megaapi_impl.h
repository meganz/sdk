...
class MegaApiImpl : public MegaApp
{
    public:
        ...
        void syncFolder(const MegaSyncConfig* syncConfig, const char *localFolder, MegaNode *megaFolder, MegaRegExp *regExp = NULL, long long localfp = 0, MegaRequestListener* listener = NULL);
...
protected:
        ...
        void sync_auto_resume_result(const string& localPath, handle remoteNode, long long localFp, const vector<string>& regExp, error e) override;
