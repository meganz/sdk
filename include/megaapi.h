...
class MegaRequest
{
    public:
        enum {
            ...
            TYPE_GET_NODES, TYPE_SEARCH_NODES, TOTAL_OF_REQUEST_TYPES
        };
        ...
        /**
         * @brief Returns a MegaNode list
         *
         * This value is valid for these request in onRequestFinish when the
         * error code is MegaError::API_OK:
         * // Todo add methos that returns this request
         *
         * The SDK retains the ownership of the returned value. It will be valid until
         * the MegaRequest object is deleted.
         *
         * @return Object with a list of nodes
         */
        virtual MegaNodeList* getNodeList() const;
};
...
class MegaApi
{
    public:
        ...
        */
        ...
        void searchAsync(MegaHandle handle, const char* pattern, bool recursive, int order, MegaRequestListener *listener = nullptr);
