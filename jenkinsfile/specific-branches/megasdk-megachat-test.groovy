    ...
    stages {
        ...
        stage('Run MEGAchat tests'){
            ...
            steps{
                script {
                    def lockLabel = ''
                    def sdkConcurrentTestAccountsUrls = [
                        'https://g.api.mega.co.nz/',
                        'https://bt1.api.mega.co.nz:444',
                        'https://bt1.api.mega.co.nz/',
                        'https://bt2.api.mega.co.nz/',
                        'https://bt3.api.mega.co.nz/',
                        'https://bt4.api.mega.co.nz/',
                        'https://bt5.api.mega.co.nz/',
                        'https://bt6.api.mega.co.nz/'
                    ]
                    if (sdkConcurrentTestAccountsUrls.contains(APIURL_TO_TEST)) {
