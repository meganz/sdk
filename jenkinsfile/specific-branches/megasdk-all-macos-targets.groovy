    ...
    stages {
        ...
        stage('Build macOS'){
            ...
            environment{
                ...
                COMMON_CMAKE_OPTIONS = "-DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_VERBOSE_MAKEFILE=ON -DENABLE_JAVA_BINDINGS=ON -DENABLE_LOG_PERFORMANCE=ON -DENABLE_QT_BINDINGS=ON -DUSE_LIBUV=ON -DVCPKG_ROOT=${VCPKGPATH}"
            }
            steps{
                //Build SDK for arm64
