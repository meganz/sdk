    ...
    stages {
        ...
        stage('Build macOS'){
            ...
            steps{
                ...
                sh "cmake -DCMAKE_PREFIX_PATH=${QTPATH}/arm64 -DENABLE_SDKLIB_WERROR=ON -DENABLE_QT_BINDINGS=ON -DENABLE_LOG_PERFORMANCE=ON -DENABLE_LIBUV=ON -DCMAKE_BUILD_TYPE=RelWithDebInfo -DVCPKG_ROOT=${VCPKGPATH} -DCMAKE_VERBOSE_MAKEFILE=ON -S ${WORKSPACE} -B ${WORKSPACE}/${BUILD_DIR}"
                ...
                sh "cmake -DCMAKE_PREFIX_PATH=${QTPATH}/x86_64 -DENABLE_SDKLIB_WERROR=ON -DENABLE_QT_BINDINGS=ON -DENABLE_LOG_PERFORMANCE=ON -DENABLE_LIBUV=ON -DCMAKE_BUILD_TYPE=RelWithDebInfo -DVCPKG_ROOT=${VCPKGPATH} -DCMAKE_VERBOSE_MAKEFILE=ON -DCMAKE_OSX_ARCHITECTURES=x86_64 -S ${WORKSPACE} -B ${WORKSPACE}/${BUILD_DIR_X64}"
