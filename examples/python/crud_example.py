...
def worker(api, listener, executor, credentials):
    ...
    if node != None:
        executor.do(api.startDownload, (node, 'README_returned.md', None, None, False, None, MegaTransfer.DOWNLOAD_SKIP_IF_SAME_FINGERPRINT, MegaTransfer.SAVE_NEW_WITH_N))
    else:
