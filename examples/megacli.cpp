...
void DemoApp::enumeratequotaitems_result(unsigned, handle, unsigned, unsigned, unsigned, unsigned, unsigned, unsigned, const char*, const char*, const char*, const char*)
{
    // FIXME: implement
}
