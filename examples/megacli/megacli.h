...
void exec_alerts_test_reminder(autocomplete::ACState& s);
void exec_alerts_test_payment(autocomplete::ACState& s);
void exec_alerts_test_payment_v2(autocomplete::ACState& s);
