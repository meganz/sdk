...
display_help() {
    ...
    echo " -I : Incremental build.  Already build dependencies will be skipped"
    ...
    echo " -C : cross-compile flags (--host etc) for 'configure' scripts (when using -X)"
    echo " -O : pass the os/compiler flag for OpenSSL (when using -X)"
