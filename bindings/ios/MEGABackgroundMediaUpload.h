 ...
 * @param adjustsSizeOnly If this is set true, then encryption is not performed, and only the length parameter is adjusted.
...
/**
 * @brief Retrieves the value of the uploadURL once it has been successfully requested via requestBackgroundUploadURLWithFileSize
 */
 ...
 *
 * The object can then be recreated via MegaApi::backgroundMediaUploadResume and supplying the same binary.
 */
- (NSData *)serialize;
