...
if [ "42be4ae879ed6870dfc5ca554d11062b536da717" != "`git rev-parse HEAD`" ]; then
  echo ""
  echo "* WARNING!!"
  echo "* You are not using our recommended commit of WebRTC: 42be4ae879ed6870dfc5ca554d11062b536da717 (branch-heads/5195)"
  echo "* Please consider to switch to that commit this way (in the src folder of WebRTC):"
  echo ""
  echo "  git checkout 42be4ae879ed6870dfc5ca554d11062b536da717"
  echo "  gclient sync"
  echo ""
