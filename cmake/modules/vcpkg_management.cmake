macro(process_vcpkg_libraries overlays_path)
    ...
    if (VCPKG_CHAINLOAD_TOOLCHAIN_FILE)
        message(STATUS "${VCPKG_CHAINLOAD_TOOLCHAIN_FILE} will be processed.")
    endif()
    ...
    if(NOT VCPKG_TARGET_TRIPLET)
        ...
        if(CMAKE_SYSTEM_NAME STREQUAL "Android")
            if(CMAKE_ANDROID_ARCH_ABI)
                set(TMP_ANDROID_ARCH_ABI ${CMAKE_ANDROID_ARCH_ABI})
            elseif(ANDROID_ABI)
                set(TMP_ANDROID_ARCH_ABI ${ANDROID_ABI})
            endif()
            if(TMP_ANDROID_ARCH_ABI STREQUAL "arm64-v8a")
                set(VCPKG_TARGET_TRIPLET "arm64-android-mega")
            elseif(TMP_ANDROID_ARCH_ABI STREQUAL "armeabi-v7a")
                set(VCPKG_TARGET_TRIPLET "arm-android-mega")
            elseif(TMP_ANDROID_ARCH_ABI STREQUAL "x86_64")
                set(VCPKG_TARGET_TRIPLET "x64-android-mega")
            elseif(TMP_ANDROID_ARCH_ABI STREQUAL "x86")
