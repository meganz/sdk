...
public:
    ...
    bool loadFingerprintsAndChildren(std::map<mega::FileFingerprint, std::map<mega::NodeHandle, mega::Node*>, mega::FileFingerprintCmp>& , std::map<mega::NodeHandle, std::map<mega::NodeHandle, mega::Node*>>&) override
    {
        return false;
    }
};
