...
TEST(Serialization, CacheableReader_32bit)
{
    ...
    const std::array<char, 125> rawData = {
        ...
        0x72, 0x78, 0x56, 0x34, 0x12, 0x21, 0x43, 0x65, static_cast<char>(0x87),
        0x65, static_cast<char>(0x87), 0x67, static_cast<char>(0x87),
        static_cast<char>(0x98), 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x05, 0x01,
        0x00, 0x09, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, static_cast<char>(0xcd),
        static_cast<char>(0xcd), static_cast<char>(0xcd),
        static_cast<char>(0xcd), static_cast<char>(0xcd), static_cast<char>(0xcd),
        static_cast<char>(0xcd), static_cast<char>(0xcd), static_cast<char>(0xcd),
        static_cast<char>(0xcd), static_cast<char>(0xcd), static_cast<char>(0xcd),
        static_cast<char>(0xcd), static_cast<char>(0xcd), static_cast<char>(0xcd),
        static_cast<char>(0xcd), 0x78, 0x03, 0x00, 0x00, 0x00,
        static_cast<char>(0xcd), static_cast<char>(0xcd), static_cast<char>(0xcd),
        0x01, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x01, 0x01
    };
    std::string writestring(rawData.data(), rawData.size());
...
TEST(Serialization, LocalNode_forFolder_32bit)
{
    ...
    // This is the result of serialization on 32bit Windows
    const std::array<char, 42> rawData = {
...
TEST(Serialization, Node_forFolder_withoutShares_32bit)
{
    ...
    // This is the result of serialization on 32bit Windows
    const std::array<char, 108> rawData = {
        static_cast<char>(0xff), static_cast<char>(0xff), static_cast<char>(0xff),
        static_cast<char>(0xff), static_cast<char>(0xff), static_cast<char>(0xff),
        static_cast<char>(0xff), static_cast<char>(0xff), 0x2a, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x2b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x2c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x58, 0x58, 0x58, 0x58,
        0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58, 0x58,
