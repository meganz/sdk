...
int ShareNodeKeys::addshare(pnode_t sn)
{
...
void ShareNodeKeys::add(pnode_t n, pnode_t sn, int specific)
{
    if (!sn)
    {
        sn = n;
...
void ShareNodeKeys::add(NodeCore* n, pnode_t sn, int specific, const byte* item, int itemlen)
{
    char buf[96];
    char* ptr;
