...
{
    return pImpl->search(nullptr, searchString, cancelToken, true, order, MegaApi::FILE_TYPE_UNKNOWN, MegaApi::SEARCH_TARGET_INSHARE);
}

MegaNodeList* MegaApi::searchOnOutShares(const char *searchString, MegaCancelToken *cancelToken, int order)
{
    return pImpl->search(nullptr, searchString, cancelToken, true, order, MegaApi::FILE_TYPE_UNKNOWN, MegaApi::SEARCH_TARGET_OUTSHARE);
}

MegaNodeList* MegaApi::searchOnPublicLinks(const char *searchString, MegaCancelToken *cancelToken, int order)
{
    return pImpl->search(nullptr, searchString, cancelToken, true, order, MegaApi::FILE_TYPE_UNKNOWN, MegaApi::SEARCH_TARGET_PUBLICLINK);
}
