...
char *MegaApi::getMimeType(const char *extension)
{
    ...
    if (!mimeMap)
    {
        ...
        if (!mimeMap)
        {
            auto newmm = new map<string, string>();
            auto& mm = *newmm;
            ...
            mm["3gp2"] = "video/3gpp2";
            mm["3gpp"] = "video/3gpp";
            mm["7z"] = "application/x-7z-compressed";
            mm["aa"] = "audio/audible";
            mm["AAC"] = "audio/aac";
            mm["aaf"] = "application/octet-stream";
            mm["aax"] = "audio/vnd.audible.aax";
            mm["ac3"] = "audio/ac3";
            mm["aca"] = "application/octet-stream";
            mm["accda"] = "application/msaccess.addin";
            mm["accdb"] = "application/msaccess";
            mm["accdc"] = "application/msaccess.cab";
            mm["accde"] = "application/msaccess";
            mm["accdr"] = "application/msaccess.runtime";
            mm["accdt"] = "application/msaccess";
            mm["accdw"] = "application/msaccess.webapplication";
            mm["accft"] = "application/msaccess.ftemplate";
            mm["acx"] = "application/internet-property-stream";
            mm["AddIn"] = "text/xml";
            mm["ade"] = "application/msaccess";
            mm["adobebridge"] = "application/x-bridge-url";
            mm["adp"] = "application/msaccess";
            mm["ADT"] = "audio/vnd.dlna.adts";
            mm["ADTS"] = "audio/aac";
            mm["afm"] = "application/octet-stream";
            mm["ai"] = "application/postscript";
            mm["aif"] = "audio/x-aiff";
            mm["aifc"] = "audio/aiff";
            mm["aiff"] = "audio/aiff";
            mm["air"] = "application/vnd.adobe.air-application-installer-package+zip";
            mm["amc"] = "application/x-mpeg";
            mm["application"] = "application/x-ms-application";
            mm["art"] = "image/x-jg";
            mm["asa"] = "application/xml";
            mm["asax"] = "application/xml";
            mm["ascx"] = "application/xml";
            mm["asd"] = "application/octet-stream";
            mm["asf"] = "video/x-ms-asf";
            mm["ashx"] = "application/xml";
            mm["asi"] = "application/octet-stream";
            mm["asm"] = "text/plain";
            mm["asmx"] = "application/xml";
            mm["aspx"] = "application/xml";
            mm["asr"] = "video/x-ms-asf";
            mm["asx"] = "video/x-ms-asf";
            mm["atom"] = "application/atom+xml";
            mm["au"] = "audio/basic";
            mm["avi"] = "video/x-msvideo";
            mm["axs"] = "application/olescript";
            mm["bas"] = "text/plain";
            mm["bcpio"] = "application/x-bcpio";
            mm["bin"] = "application/octet-stream";
            mm["bmp"] = "image/bmp";
            mm["c"] = "text/plain";
            mm["cab"] = "application/octet-stream";
            mm["caf"] = "audio/x-caf";
            mm["calx"] = "application/vnd.ms-office.calx";
            mm["cat"] = "application/vnd.ms-pki.seccat";
            mm["cc"] = "text/plain";
            mm["cd"] = "text/plain";
            mm["cdda"] = "audio/aiff";
            mm["cdf"] = "application/x-cdf";
            mm["cer"] = "application/x-x509-ca-cert";
            mm["chm"] = "application/octet-stream";
            mm["class"] = "application/x-java-applet";
            mm["clp"] = "application/x-msclip";
            mm["cmx"] = "image/x-cmx";
            mm["cnf"] = "text/plain";
            mm["cod"] = "image/cis-cod";
            mm["config"] = "application/xml";
            mm["contact"] = "text/x-ms-contact";
            mm["coverage"] = "application/xml";
            mm["cpio"] = "application/x-cpio";
            mm["cpp"] = "text/plain";
            mm["crd"] = "application/x-mscardfile";
            mm["crl"] = "application/pkix-crl";
            mm["crt"] = "application/x-x509-ca-cert";
            mm["cs"] = "text/plain";
            mm["csdproj"] = "text/plain";
            mm["csh"] = "application/x-csh";
            mm["csproj"] = "text/plain";
            mm["css"] = "text/css";
            mm["csv"] = "text/csv";
            mm["cur"] = "application/octet-stream";
            mm["cxx"] = "text/plain";
            mm["dat"] = "application/octet-stream";
            mm["datasource"] = "application/xml";
            mm["dbproj"] = "text/plain";
            mm["dcr"] = "application/x-director";
            mm["def"] = "text/plain";
            mm["deploy"] = "application/octet-stream";
            mm["der"] = "application/x-x509-ca-cert";
            mm["dgml"] = "application/xml";
            mm["dib"] = "image/bmp";
            mm["dif"] = "video/x-dv";
            mm["dir"] = "application/x-director";
            mm["disco"] = "text/xml";
            mm["dll"] = "application/x-msdownload";
            mm["dll.config"] = "text/xml";
            mm["dlm"] = "text/dlm";
            mm["doc"] = "application/msword";
            mm["docm"] = "application/vnd.ms-word.document.macroEnabled.12";
            mm["docx"] = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
            mm["dot"] = "application/msword";
            mm["dotm"] = "application/vnd.ms-word.template.macroEnabled.12";
            mm["dotx"] = "application/vnd.openxmlformats-officedocument.wordprocessingml.template";
            mm["dsp"] = "application/octet-stream";
            mm["dsw"] = "text/plain";
            mm["dtd"] = "text/xml";
            mm["dtsConfig"] = "text/xml";
            mm["dv"] = "video/x-dv";
            mm["dvi"] = "application/x-dvi";
            mm["dwf"] = "drawing/x-dwf";
            mm["dwp"] = "application/octet-stream";
            mm["dxr"] = "application/x-director";
            mm["eml"] = "message/rfc822";
            mm["emz"] = "application/octet-stream";
            mm["eot"] = "application/octet-stream";
            mm["eps"] = "application/postscript";
            mm["etl"] = "application/etl";
            mm["etx"] = "text/x-setext";
            mm["evy"] = "application/envoy";
            mm["exe"] = "application/octet-stream";
            mm["exe.config"] = "text/xml";
            mm["fdf"] = "application/vnd.fdf";
            mm["fif"] = "application/fractals";
            mm["filters"] = "Application/xml";
            mm["fla"] = "application/octet-stream";
            mm["flr"] = "x-world/x-vrml";
            mm["flv"] = "video/x-flv";
            mm["fsscript"] = "application/fsharp-script";
            mm["fsx"] = "application/fsharp-script";
            mm["generictest"] = "application/xml";
            mm["gif"] = "image/gif";
            mm["group"] = "text/x-ms-group";
            mm["gsm"] = "audio/x-gsm";
            mm["gtar"] = "application/x-gtar";
            mm["gz"] = "application/x-gzip";
            mm["h"] = "text/plain";
            mm["hdf"] = "application/x-hdf";
            mm["hdml"] = "text/x-hdml";
            mm["hhc"] = "application/x-oleobject";
            mm["hhk"] = "application/octet-stream";
            mm["hhp"] = "application/octet-stream";
            mm["hlp"] = "application/winhlp";
            mm["hpp"] = "text/plain";
            mm["hqx"] = "application/mac-binhex40";
            mm["hta"] = "application/hta";
            mm["htc"] = "text/x-component";
            mm["htm"] = "text/html";
            mm["html"] = "text/html";
            mm["htt"] = "text/webviewhtml";
            mm["hxa"] = "application/xml";
            mm["hxc"] = "application/xml";
            mm["hxd"] = "application/octet-stream";
            mm["hxe"] = "application/xml";
            mm["hxf"] = "application/xml";
            mm["hxh"] = "application/octet-stream";
            mm["hxi"] = "application/octet-stream";
            mm["hxk"] = "application/xml";
            mm["hxq"] = "application/octet-stream";
            mm["hxr"] = "application/octet-stream";
            mm["hxs"] = "application/octet-stream";
            mm["hxt"] = "text/html";
            mm["hxv"] = "application/xml";
            mm["hxw"] = "application/octet-stream";
            mm["hxx"] = "text/plain";
            mm["i"] = "text/plain";
            mm["ico"] = "image/x-icon";
            mm["ics"] = "application/octet-stream";
            mm["idl"] = "text/plain";
            mm["ief"] = "image/ief";
            mm["iii"] = "application/x-iphone";
            mm["inc"] = "text/plain";
            mm["inf"] = "application/octet-stream";
            mm["inl"] = "text/plain";
            mm["ins"] = "application/x-internet-signup";
            mm["ipa"] = "application/x-itunes-ipa";
            mm["ipg"] = "application/x-itunes-ipg";
            mm["ipproj"] = "text/plain";
            mm["ipsw"] = "application/x-itunes-ipsw";
            mm["iqy"] = "text/x-ms-iqy";
            mm["isp"] = "application/x-internet-signup";
            mm["ite"] = "application/x-itunes-ite";
            mm["itlp"] = "application/x-itunes-itlp";
            mm["itms"] = "application/x-itunes-itms";
            mm["itpc"] = "application/x-itunes-itpc";
            mm["IVF"] = "video/x-ivf";
            mm["jar"] = "application/java-archive";
            mm["java"] = "application/octet-stream";
            mm["jck"] = "application/liquidmotion";
            mm["jcz"] = "application/liquidmotion";
            mm["jfif"] = "image/pjpeg";
            mm["jnlp"] = "application/x-java-jnlp-file";
            mm["jpb"] = "application/octet-stream";
            mm["jpe"] = "image/jpeg";
            mm["jpeg"] = "image/jpeg";
            mm["jpg"] = "image/jpeg";
            mm["js"] = "application/x-javascript";
            mm["json"] = "application/json";
            mm["jsx"] = "text/jscript";
            mm["jsxbin"] = "text/plain";
            mm["latex"] = "application/x-latex";
            mm["library-ms"] = "application/windows-library+xml";
            mm["lit"] = "application/x-ms-reader";
            mm["loadtest"] = "application/xml";
            mm["lpk"] = "application/octet-stream";
            mm["lsf"] = "video/x-la-asf";
            mm["lst"] = "text/plain";
            mm["lsx"] = "video/x-la-asf";
            mm["lzh"] = "application/octet-stream";
            mm["m13"] = "application/x-msmediaview";
            mm["m14"] = "application/x-msmediaview";
            mm["m1v"] = "video/mpeg";
            mm["m2t"] = "video/vnd.dlna.mpeg-tts";
            mm["m2ts"] = "video/vnd.dlna.mpeg-tts";
            mm["m2v"] = "video/mpeg";
            mm["m3u"] = "audio/x-mpegurl";
            mm["m3u8"] = "audio/x-mpegurl";
            mm["m4a"] = "audio/m4a";
            mm["m4b"] = "audio/m4b";
            mm["m4p"] = "audio/m4p";
            mm["m4r"] = "audio/x-m4r";
            mm["m4v"] = "video/x-m4v";
            mm["mac"] = "image/x-macpaint";
            mm["mak"] = "text/plain";
            mm["man"] = "application/x-troff-man";
            mm["manifest"] = "application/x-ms-manifest";
            mm["map"] = "text/plain";
            mm["master"] = "application/xml";
            mm["mda"] = "application/msaccess";
            mm["mdb"] = "application/x-msaccess";
            mm["mde"] = "application/msaccess";
            mm["mdp"] = "application/octet-stream";
            mm["me"] = "application/x-troff-me";
            mm["mfp"] = "application/x-shockwave-flash";
            mm["mht"] = "message/rfc822";
            mm["mhtml"] = "message/rfc822";
            mm["mid"] = "audio/mid";
            mm["midi"] = "audio/mid";
            mm["mix"] = "application/octet-stream";
            mm["mk"] = "text/plain";
            mm["mmf"] = "application/x-smaf";
            mm["mno"] = "text/xml";
            mm["mny"] = "application/x-msmoney";
            mm["mod"] = "video/mpeg";
            mm["mov"] = "video/quicktime";
            mm["movie"] = "video/x-sgi-movie";
            mm["mp2"] = "video/mpeg";
            mm["mp2v"] = "video/mpeg";
            mm["mp3"] = "audio/mpeg";
            mm["mp4"] = "video/mp4";
            ...
            mm["mpe"] = "video/mpeg";
            mm["mpeg"] = "video/mpeg";
            mm["mpf"] = "application/vnd.ms-mediapackage";
            mm["mpg"] = "video/mpeg";
            mm["mpp"] = "application/vnd.ms-project";
            mm["mpv2"] = "video/mpeg";
            mm["mqv"] = "video/quicktime";
            mm["ms"] = "application/x-troff-ms";
            mm["msi"] = "application/octet-stream";
            mm["mso"] = "application/octet-stream";
            mm["mts"] = "video/vnd.dlna.mpeg-tts";
            mm["mtx"] = "application/xml";
            mm["mvb"] = "application/x-msmediaview";
            mm["mvc"] = "application/x-miva-compiled";
            mm["mxp"] = "application/x-mmxp";
            mm["nc"] = "application/x-netcdf";
            mm["nsc"] = "video/x-ms-asf";
            mm["nws"] = "message/rfc822";
            mm["ocx"] = "application/octet-stream";
            mm["oda"] = "application/oda";
            mm["odc"] = "text/x-ms-odc";
            mm["odh"] = "text/plain";
            mm["odl"] = "text/plain";
            mm["odp"] = "application/vnd.oasis.opendocument.presentation";
            mm["ods"] = "application/oleobject";
            mm["odt"] = "application/vnd.oasis.opendocument.text";
            mm["one"] = "application/onenote";
            mm["onea"] = "application/onenote";
            mm["onepkg"] = "application/onenote";
            mm["onetmp"] = "application/onenote";
            mm["onetoc"] = "application/onenote";
            mm["onetoc2"] = "application/onenote";
            mm["orderedtest"] = "application/xml";
            mm["osdx"] = "application/opensearchdescription+xml";
            mm["p10"] = "application/pkcs10";
            mm["p12"] = "application/x-pkcs12";
            mm["p7b"] = "application/x-pkcs7-certificates";
            mm["p7c"] = "application/pkcs7-mime";
            mm["p7m"] = "application/pkcs7-mime";
            mm["p7r"] = "application/x-pkcs7-certreqresp";
            mm["p7s"] = "application/pkcs7-signature";
            mm["pbm"] = "image/x-portable-bitmap";
            mm["pcast"] = "application/x-podcast";
            mm["pct"] = "image/pict";
            mm["pcx"] = "application/octet-stream";
            mm["pcz"] = "application/octet-stream";
            mm["pdf"] = "application/pdf";
            mm["pfb"] = "application/octet-stream";
            mm["pfm"] = "application/octet-stream";
            mm["pfx"] = "application/x-pkcs12";
            mm["pgm"] = "image/x-portable-graymap";
            mm["pic"] = "image/pict";
            mm["pict"] = "image/pict";
            mm["pkgdef"] = "text/plain";
            mm["pkgundef"] = "text/plain";
            mm["pko"] = "application/vnd.ms-pki.pko";
            mm["pls"] = "audio/scpls";
            mm["pma"] = "application/x-perfmon";
            mm["pmc"] = "application/x-perfmon";
            mm["pml"] = "application/x-perfmon";
            mm["pmr"] = "application/x-perfmon";
            mm["pmw"] = "application/x-perfmon";
            mm["png"] = "image/png";
            mm["pnm"] = "image/x-portable-anymap";
            mm["pnt"] = "image/x-macpaint";
            mm["pntg"] = "image/x-macpaint";
            mm["pnz"] = "image/png";
            mm["pot"] = "application/vnd.ms-powerpoint";
            mm["potm"] = "application/vnd.ms-powerpoint.template.macroEnabled.12";
            mm["potx"] = "application/vnd.openxmlformats-officedocument.presentationml.template";
            mm["ppa"] = "application/vnd.ms-powerpoint";
            mm["ppam"] = "application/vnd.ms-powerpoint.addin.macroEnabled.12";
            mm["ppm"] = "image/x-portable-pixmap";
            mm["pps"] = "application/vnd.ms-powerpoint";
            mm["ppsm"] = "application/vnd.ms-powerpoint.slideshow.macroEnabled.12";
            mm["ppsx"] = "application/vnd.openxmlformats-officedocument.presentationml.slideshow";
            mm["ppt"] = "application/vnd.ms-powerpoint";
            mm["pptm"] = "application/vnd.ms-powerpoint.presentation.macroEnabled.12";
            mm["pptx"] = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
            mm["prf"] = "application/pics-rules";
            mm["prm"] = "application/octet-stream";
            mm["prx"] = "application/octet-stream";
            mm["ps"] = "application/postscript";
            mm["psc1"] = "application/PowerShell";
            mm["psd"] = "application/octet-stream";
            mm["psess"] = "application/xml";
            mm["psm"] = "application/octet-stream";
            mm["psp"] = "application/octet-stream";
            mm["pub"] = "application/x-mspublisher";
            mm["pwz"] = "application/vnd.ms-powerpoint";
            mm["qht"] = "text/x-html-insertion";
            mm["qhtm"] = "text/x-html-insertion";
            mm["qt"] = "video/quicktime";
            mm["qti"] = "image/x-quicktime";
            mm["qtif"] = "image/x-quicktime";
            mm["qtl"] = "application/x-quicktimeplayer";
            mm["qxd"] = "application/octet-stream";
            mm["ra"] = "audio/x-pn-realaudio";
            mm["ram"] = "audio/x-pn-realaudio";
            mm["rar"] = "application/octet-stream";
            mm["ras"] = "image/x-cmu-raster";
            mm["rat"] = "application/rat-file";
            mm["rc"] = "text/plain";
            mm["rc2"] = "text/plain";
            mm["rct"] = "text/plain";
            mm["rdlc"] = "application/xml";
            mm["resx"] = "application/xml";
            mm["rf"] = "image/vnd.rn-realflash";
            mm["rgb"] = "image/x-rgb";
            mm["rgs"] = "text/plain";
            mm["rm"] = "application/vnd.rn-realmedia";
            mm["rmi"] = "audio/mid";
            mm["rmp"] = "application/vnd.rn-rn_music_package";
            mm["roff"] = "application/x-troff";
            mm["rpm"] = "audio/x-pn-realaudio-plugin";
            mm["rqy"] = "text/x-ms-rqy";
            mm["rtf"] = "application/rtf";
            mm["rtx"] = "text/richtext";
            mm["ruleset"] = "application/xml";
            mm["s"] = "text/plain";
            mm["safariextz"] = "application/x-safari-safariextz";
            mm["scd"] = "application/x-msschedule";
            mm["sct"] = "text/scriptlet";
            mm["sd2"] = "audio/x-sd2";
            mm["sdp"] = "application/sdp";
            mm["sea"] = "application/octet-stream";
            mm["searchConnector-ms"] = "application/windows-search-connector+xml";
            mm["setpay"] = "application/set-payment-initiation";
            mm["setreg"] = "application/set-registration-initiation";
            mm["settings"] = "application/xml";
            mm["sgimb"] = "application/x-sgimb";
            mm["sgml"] = "text/sgml";
            mm["sh"] = "application/x-sh";
            mm["shar"] = "application/x-shar";
            mm["shtml"] = "text/html";
            mm["sit"] = "application/x-stuffit";
            mm["sitemap"] = "application/xml";
            mm["skin"] = "application/xml";
            mm["sldm"] = "application/vnd.ms-powerpoint.slide.macroEnabled.12";
            mm["sldx"] = "application/vnd.openxmlformats-officedocument.presentationml.slide";
            mm["slk"] = "application/vnd.ms-excel";
            mm["sln"] = "text/plain";
            mm["slupkg-ms"] = "application/x-ms-license";
            mm["smd"] = "audio/x-smd";
            mm["smi"] = "application/octet-stream";
            mm["smx"] = "audio/x-smd";
            mm["smz"] = "audio/x-smd";
            mm["snd"] = "audio/basic";
            mm["snippet"] = "application/xml";
            mm["snp"] = "application/octet-stream";
            mm["sol"] = "text/plain";
            mm["sor"] = "text/plain";
            mm["spc"] = "application/x-pkcs7-certificates";
            mm["spl"] = "application/futuresplash";
            mm["src"] = "application/x-wais-source";
            mm["srf"] = "text/plain";
            mm["SSISDeploymentManifest"] = "text/xml";
            mm["ssm"] = "application/streamingmedia";
            mm["sst"] = "application/vnd.ms-pki.certstore";
            mm["stl"] = "application/vnd.ms-pki.stl";
            mm["sv4cpio"] = "application/x-sv4cpio";
            mm["sv4crc"] = "application/x-sv4crc";
            mm["svc"] = "application/xml";
            mm["swf"] = "application/x-shockwave-flash";
            mm["t"] = "application/x-troff";
            mm["tar"] = "application/x-tar";
            mm["tcl"] = "application/x-tcl";
            mm["testrunconfig"] = "application/xml";
            mm["testsettings"] = "application/xml";
            mm["tex"] = "application/x-tex";
            mm["texi"] = "application/x-texinfo";
            mm["texinfo"] = "application/x-texinfo";
            mm["tgz"] = "application/x-compressed";
            mm["thmx"] = "application/vnd.ms-officetheme";
            mm["thn"] = "application/octet-stream";
            mm["tif"] = "image/tiff";
            mm["tiff"] = "image/tiff";
            mm["tlh"] = "text/plain";
            mm["tli"] = "text/plain";
            mm["toc"] = "application/octet-stream";
            mm["tr"] = "application/x-troff";
            mm["trm"] = "application/x-msterminal";
            mm["trx"] = "application/xml";
            mm["ts"] = "video/vnd.dlna.mpeg-tts";
            mm["tsv"] = "text/tab-separated-values";
            mm["ttf"] = "application/octet-stream";
            mm["tts"] = "video/vnd.dlna.mpeg-tts";
            mm["txt"] = "text/plain";
            mm["u32"] = "application/octet-stream";
            mm["uls"] = "text/iuls";
            mm["user"] = "text/plain";
            mm["ustar"] = "application/x-ustar";
            mm["vb"] = "text/plain";
            mm["vbdproj"] = "text/plain";
            mm["vbk"] = "video/mpeg";
            mm["vbproj"] = "text/plain";
            mm["vbs"] = "text/vbscript";
            mm["vcf"] = "text/x-vcard";
            mm["vcproj"] = "Application/xml";
            mm["vcs"] = "text/plain";
            mm["vcxproj"] = "Application/xml";
            mm["vddproj"] = "text/plain";
            mm["vdp"] = "text/plain";
            mm["vdproj"] = "text/plain";
            mm["vdx"] = "application/vnd.ms-visio.viewer";
            mm["vml"] = "text/xml";
            mm["vscontent"] = "application/xml";
            mm["vsct"] = "text/xml";
            mm["vsd"] = "application/vnd.visio";
            mm["vsi"] = "application/ms-vsi";
            mm["vsix"] = "application/vsix";
            mm["vsixlangpack"] = "text/xml";
            mm["vsixmanifest"] = "text/xml";
            mm["vsmdi"] = "application/xml";
            mm["vspscc"] = "text/plain";
            mm["vss"] = "application/vnd.visio";
            mm["vsscc"] = "text/plain";
            mm["vssettings"] = "text/xml";
            mm["vssscc"] = "text/plain";
            mm["vst"] = "application/vnd.visio";
            mm["vstemplate"] = "text/xml";
            mm["vsto"] = "application/x-ms-vsto";
            mm["vsw"] = "application/vnd.visio";
            mm["vsx"] = "application/vnd.visio";
            mm["vtx"] = "application/vnd.visio";
            mm["wav"] = "audio/wav";
            mm["wave"] = "audio/wav";
            mm["wax"] = "audio/x-ms-wax";
            mm["wbk"] = "application/msword";
            mm["wbmp"] = "image/vnd.wap.wbmp";
            mm["wcm"] = "application/vnd.ms-works";
            mm["wdb"] = "application/vnd.ms-works";
            mm["wdp"] = "image/vnd.ms-photo";
            mm["webarchive"] = "application/x-safari-webarchive";
            mm["webtest"] = "application/xml";
            mm["wiq"] = "application/xml";
            mm["wiz"] = "application/msword";
            mm["wks"] = "application/vnd.ms-works";
            mm["WLMP"] = "application/wlmoviemaker";
            mm["wlpginstall"] = "application/x-wlpg-detect";
            mm["wlpginstall3"] = "application/x-wlpg3-detect";
            mm["wm"] = "video/x-ms-wm";
            mm["wma"] = "audio/x-ms-wma";
            mm["wmd"] = "application/x-ms-wmd";
            mm["wmf"] = "application/x-msmetafile";
            mm["wml"] = "text/vnd.wap.wml";
            mm["wmlc"] = "application/vnd.wap.wmlc";
            mm["wmls"] = "text/vnd.wap.wmlscript";
            mm["wmlsc"] = "application/vnd.wap.wmlscriptc";
            mm["wmp"] = "video/x-ms-wmp";
            mm["wmv"] = "video/x-ms-wmv";
            mm["wmx"] = "video/x-ms-wmx";
            mm["wmz"] = "application/x-ms-wmz";
            mm["wpl"] = "application/vnd.ms-wpl";
            mm["wps"] = "application/vnd.ms-works";
            mm["wri"] = "application/x-mswrite";
            mm["wrl"] = "x-world/x-vrml";
            mm["wrz"] = "x-world/x-vrml";
            mm["wsc"] = "text/scriptlet";
            mm["wsdl"] = "text/xml";
            mm["wvx"] = "video/x-ms-wvx";
            mm["x"] = "application/directx";
            mm["xaf"] = "x-world/x-vrml";
            mm["xaml"] = "application/xaml+xml";
            mm["xap"] = "application/x-silverlight-app";
            mm["xbap"] = "application/x-ms-xbap";
            mm["xbm"] = "image/x-xbitmap";
            mm["xdr"] = "text/plain";
            mm["xht"] = "application/xhtml+xml";
            mm["xhtml"] = "application/xhtml+xml";
            mm["xla"] = "application/vnd.ms-excel";
            mm["xlam"] = "application/vnd.ms-excel.addin.macroEnabled.12";
            mm["xlc"] = "application/vnd.ms-excel";
            mm["xld"] = "application/vnd.ms-excel";
            mm["xlk"] = "application/vnd.ms-excel";
            mm["xll"] = "application/vnd.ms-excel";
            mm["xlm"] = "application/vnd.ms-excel";
            mm["xls"] = "application/vnd.ms-excel";
            mm["xlsb"] = "application/vnd.ms-excel.sheet.binary.macroEnabled.12";
            mm["xlsm"] = "application/vnd.ms-excel.sheet.macroEnabled.12";
            mm["xlsx"] = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
            mm["xlt"] = "application/vnd.ms-excel";
            mm["xltm"] = "application/vnd.ms-excel.template.macroEnabled.12";
            mm["xltx"] = "application/vnd.openxmlformats-officedocument.spreadsheetml.template";
            mm["xlw"] = "application/vnd.ms-excel";
            mm["xml"] = "text/xml";
            mm["xmta"] = "application/xml";
            mm["xof"] = "x-world/x-vrml";
            mm["XOML"] = "text/plain";
            mm["xpm"] = "image/x-xpixmap";
            mm["xps"] = "application/vnd.ms-xpsdocument";
            mm["xrm-ms"] = "text/xml";
            mm["xsc"] = "application/xml";
            mm["xsd"] = "text/xml";
            mm["xsf"] = "text/xml";
            mm["xsl"] = "text/xml";
            mm["xslt"] = "text/xml";
            mm["xsn"] = "application/octet-stream";
            mm["xss"] = "application/xml";
            mm["xtp"] = "application/octet-stream";
            mm["xwd"] = "image/x-xwindowdump";
            mm["z"] = "application/x-compress";
            mm["zip"] = "application/x-zip-compressed";
            mimeMap = newmm;
        }
    }
