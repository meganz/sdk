...
{
    return pImpl->search(nullptr, searchString, nullptr, true, order, MegaApi::FILE_TYPE_DEFAULT, MegaApi::SEARCH_TARGET_ALL);
}

MegaNodeList *MegaApi::search(const char *searchString, MegaCancelToken *cancelToken, int order)
{
    return pImpl->search(nullptr, searchString, cancelToken, true, order, MegaApi::FILE_TYPE_DEFAULT, MegaApi::SEARCH_TARGET_ALL);
}
