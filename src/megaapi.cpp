...
void MegaApi::createPublicChat(MegaTextChatPeerList *peers, const char *unifiedKey, const char *title, MegaRequestListener *listener)
{
    pImpl->createChat(true, true, peers, unifiedKey, title, listener);
}
