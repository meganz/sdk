...
void MegaApi::resumeCreateAccount(MegaHandle userhandle, const char *pwcipher, MegaRequestListener *listener)
{
    pImpl->resumeCreateAccount(userhandle, pwcipher, listener);
}
