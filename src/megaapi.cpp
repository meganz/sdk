...
void MegaApi::createFolderTree(const MegaStringMultivector *folderStructure, MegaHandle target, MegaRequestListener *listener)
{
    pImpl->createFolderTree(folderStructure, target, listener);
}
