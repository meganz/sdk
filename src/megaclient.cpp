...
#ifdef ENABLE_CHAT
void MegaClient::createChat(bool group, bool openchat, const userpriv_vector *userpriv, const char *title)
{
    reqs.add(new CommandChatCreate(this, group, openchat, userpriv, title));
}
