...
Node *NodeManager::getNodeFromNodeSerialized(const NodeSerialized &nodeSerialized)
{
    ...
    if (!node)
    {
        ...
        mClient.fetchnodes(true, false, true);  // TODO:  We should not be randomly firing off fetchnodes() randomly like this.  Likely to sabotage whatever is going on, and to sometimes result in self-DDOS
        return nullptr;
    }
...
#ifdef ENABLE_SYNC
// TODO: adapt this sds code to sync rework
/*
