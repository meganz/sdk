...
bool MegaClient::decryptNodeMetadata(SetElement::NodeMetadata& nodeMeta, const string& key)
{
    ...
    if (!buf)
    {
        LOG_err << "Decrypting node attributes failed. Node Handle = " << toHandle(nodeMeta.h);
        return false;
    }
    ...
    for (bool jsonHasData = true; jsonHasData;)
    {
        ...
        case 'c':
            ...
            {
                LOG_err << "Reading node fingerprint failed. Node Handle = " << toHandle(nodeMeta.h);
            }
            break;
        ...
        case 'n':
            ...
            {
                LOG_err << "Reading node filename failed. Node Handle = " << toHandle(nodeMeta.h);
            }
            break;
        ...
        default:
            ...
            {
                LOG_err << "Skipping unexpected node attribute failed. Node Handle = " << toHandle(nodeMeta.h);
            }
        }
    }
