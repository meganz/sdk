                                ...
                                std::optional<Pitag> pitag)
{
    ...
    newnode->fileattributes = std::move(fileAttr);
...
std::optional<Pitag> SyncUpload_inClient::buildSyncUploadPitag() const
{
...
std::optional<Pitag> SyncUpload_inClient::buildSyncClonePitag() const
{
