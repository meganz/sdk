...
void MegaApiImpl::whyamiblocked_result(int code)
{
    ...
    else    // code > 0
    {
        ...
        else if (code == MegaApi::ACCOUNT_SUSPENSION_SUBUSER_REMOVED)
        {
        ...
        else if (code == MegaApi::ACCOUNT_SUSPENSION_VERIFICATION_SMS)
        {
            reason = "Your account has been blocked pending verification via SMS.";
        }
        else if (code == MegaApi::ACCOUNT_SUSPENSION_VERIFICATION_EMAIL)
        {
