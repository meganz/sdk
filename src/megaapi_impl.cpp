...
{
    syncFolder(MegaSyncConfig::createInstance(), localFolder, megaFolder, regExp, localfp, listener);
}

void MegaApiImpl::syncFolder(const MegaSyncConfig* syncConfig, const char *localFolder, MegaNode *megaFolder, MegaRegExp *regExp, long long localfp, MegaRequestListener *listener)
{
