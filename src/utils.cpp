...
{
    std::cout << "[chunkmac_map::calcprogress] BEGIN [size = " << size << ", chunkpos = " << chunkpos << ", progresscompleted = " << progresscompleted << ", sumOfPartialChunks = " << (sumOfPartialChunks ? *sumOfPartialChunks : 0) << "]" << "  [thread_id=" << std::this_thread::get_id() << "]" << std::endl;;
    chunkpos = 0;
    progresscompleted = 0;
    ...
    std::cout << "[chunkmac_map::calcprogress] BEGIN [progresscompleted = " << progresscompleted << ", chunkpos = progresscontiguous = " << chunkpos << ", progresscompleted = " << progresscompleted << ", sumOfPartialChunks = " << (sumOfPartialChunks ? *sumOfPartialChunks : 0) << "]" << "  [thread_id=" << std::this_thread::get_id() << "]" << std::endl;;
