...
CommandSetAttr::CommandSetAttr(MegaClient* client, shared_ptr<Node> n, SymmCipher* cipher)
{
    cmd("a");
    notself(client);
...
CommandMoveNode::CommandMoveNode(MegaClient* client, shared_ptr<Node> n, shared_ptr<Node> t, syncdel_t csyncdel)
{
    h = n->nodehandle;
    syncdel = csyncdel;
